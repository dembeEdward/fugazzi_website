(function (){
	...
	app.controller("loginCtrl", function($scope, $http, auth, store, $location){
	...
	app.controller("homepageCtrl", function($scope, GeolocationService, Map, $http, store, auth, $location){
